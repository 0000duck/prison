...
@Component
	...
	public String queryUserId(String cusNumber,String policeId){
		String policeInfo=RedisUtil.getHashMap(cacheId+"_"+cusNumber, policeId).toString();
		List<String> paraList=new ArrayList<String>();
		if(StringUtil.isNull(policeInfo)){
			paraList.add(cusNumber);
			paraList.add(policeId);
			queryPoliceBaseDtls(paraList,"1");
		}
		JSONObject policeObj=JSONObject.parseObject(policeInfo);
		String userId=policeObj.getString("pbd_user_id");
		return userId;
	}
	@Override
