	...
	function initTable (request) {
		table.init("table", {
			...
			columns: [[
			    ...
			    {title: '编号', field: 'vel_id', align: 'center', valign: 'middle'},
	            {title: '视频事件', field: 'vel_event_name', align: 'center', valign: 'middle'},
	            {title: '存储地址', field: 'vel_storage_addr', align: 'center', valign: 'middle'},
