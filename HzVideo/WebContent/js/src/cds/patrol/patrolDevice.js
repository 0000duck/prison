define(function(require){
	...
	function saveSuccess(m,t){
		 ...
		 if(t=='u'){
			 var node = areaPatrolTree.getNodeByTId(vm.patrol.tId);
			 var pnode = areaPatrolTree.getNodesByParam('id',vm.patrol.pid);
			 node = vm.patrol;
			 ...
			 areaPatrolTree.addNodes(pnode[0],vm.patrol);
			 vm.treeData.push(vm.patrol);
		 }else if(t=='d'){
			 var node = areaPatrolTree.getNodeByTId(vm.patrol.tId);
