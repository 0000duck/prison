define(function(require) {
    ...
    var DiyControls = function(object, domElement, floor, EventConsts) {
        ...
        var baseTime = 34; //60帧的最佳效果 1帧的毫秒数
        ...
        this.minPolarAngle = 0.0002; // radians
        this.maxPolarAngle = (Math.PI / 2) - 0.1; // radians
        const maxPolarAngleFloor = (Math.PI / 2) - 0.001; //注视点在地面的角度
        const maxPolarAngleBuild = (Math.PI / 2); //注视点建筑物上可能上仰视去看
        ...
        this.update = function() {
            ...
            return function update() {
                ...
                var scaleTime = Math.ceil(delta / baseTime);
        ...
        function flyWayLookAtTo(pos1, disRadius, disHeight, needTime) {
            ...
            var y1 = Math.cos(0) * disRadius + pos1.z;
            ...
            let startPos = { posX: pos.x, posY: pos.y, posZ: pos.z, rotX: radians.x, rotY: radians.y, rotZ: radians.z, tarX: target.x, tarY: target.y, tarZ: target.z };
            let endPos = { posX: x1, posY: pos1.y + disHeight, posZ: y1, rotX: -Math.atan2(disHeight, disRadius), rotY: 0, rotZ: 0, tarX: pos1.x, tarY: pos1.Y, tarZ: pos1.z };
            ...
            new TWEEN.Tween(startPos)
                ...
                .onComplete(
                    function() {
                        isFlying = false;
                        let a = new THREE.Vector3(x1, pos1.y + disHeight, y1);
