 ...
 * 
 */
public class MessageProductTest1 {
...
/*			JSONObject json = new JSONObject();
			...
			JSONObject body = new JSONObject();
			body.put("alarmID", "237"); 
			body.put("alarmDeviceType", "6"); 
			body.put("alarmType","1"); 
			body.put("alarmTime","2016-12-19 15:01:01");
...
/*			MsgHeader msgHeader = new MsgHeader();
			...
			body.put("doorId", "2"); 
			body.put("cardId", "1"); 
			body.put("brushCardTime","2016-12-07 13:01:01"); 
...
*/
			...
			ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.3.87:8001");
