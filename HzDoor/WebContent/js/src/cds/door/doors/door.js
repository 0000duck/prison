define(['jquery','vue','frm/hz.db',"frm/loginUser","frm/treeUtil","frm/model","frm/treeSelect","frm/message","frm/dialog","frm/select"],function($,tpl,db,login,util,modelUtil,treeSelect,tip){
