define(['jquery','vue','frm/hz.db',"frm/loginUser","frm/treeSelect","frm/model","frm/message","frm/treeUtil","frm/select"],function($,tpl,db,login,treeSelect,modelUtil,tip,util){
	//
	var model=new tpl({
			el:'#form',
			data:{
