define(["jquery","frm/dialog",'hz/map/map.handle',"frm/message","frm/loginUser","frm/hz.door","frm/loginUser","frm/hz.db","vue"],function($,dialog,map,tip,login,doorCmd,login,db,tpl){
	...
	//监听事件
	setTimeout(function(){
		window.top.webmessage&&window.top.webmessage.on('DOOR001','door',doorFnc);
		window.top.webmessage&&window.top.webmessage.on('DOOR006','doorlisten',doorOpr);
	},9000);
});   