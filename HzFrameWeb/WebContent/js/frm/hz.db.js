...
define(function (require) {
	...
	function _request (method, options) {
		...
		// 请求处理
		utils.ajax(url, args, reqs, reqe, async);
	}
	...
	function _query (options) {
		// 默认走"?"参数形式的处理
		var params = options.request.params;
		var method = 'query';
		...
		_request(method, _fmtQueryOptions(options));
	}
	...
	function _page (options) {
		_query(options);
//		_request('queryPage', _fmtQueryOptions(options));
	}
	 ...
	 * 格式化查询请求的参数
	 */
	function _fmtQueryOptions (options) {
