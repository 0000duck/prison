	...
	var base={
			init:function(selector,options){
				...
				options=$.extend({
					...
					url:!options.request.url?'/'+prjName+'/dbCtrl/queryByParamKey':options.request.url,
					...
					searchAlign:'left',
					//showRefresh:true,
					search:!options.search ? false : true,
					showColumns:!options.showColumns ?  true : options.showColumns,
					iconSize:'sm',
					showExport:'true',
					method:"post",
