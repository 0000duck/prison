	...
	var vm = new vue({
		...
		watch:{
			...
			weekCheck:function(val,oldVal){
				...
				this.neverCheck = neverCheckFlag;
			}
		},
		methods:{
			audition:function(i){		//试听
				...
				obj.load();
				dialog.open({targetId:'audio-div',title:'试听播放器',h:'75',w:'300',closeCallback:function(){
					//音乐窗口关闭回调
...
//				var name = getCheckDeviceId().device_name;
			...
			saveTask:function(){
				...
				timerTask.addTimerTask(this.playTask);
				dialog.close();
			},
